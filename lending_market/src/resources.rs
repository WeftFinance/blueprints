...
pub fn create_admin_badge(
    ...
    ResourceBuilder::new_integer_non_fungible::<AdminBadgeData>(OwnerRole::Fixed(
        owner_rule.clone(),
    ))
...
pub fn create_cdp_res_manager(
    ...
    ResourceBuilder::new_integer_non_fungible::<CollaterizedDebtPositionData>(OwnerRole::Fixed(
        owner_rule.clone(),
    ))
...
pub fn create_transient_res_manager(
    ...
    ResourceBuilder::new_ruid_non_fungible::<TransientResData>(OwnerRole::Fixed(owner_rule.clone()))
        .mint_roles(mint_roles! {
            minter => component_rule.clone();
            minter_updater => rule!(deny_all);
        })
